  ...
  renderPlay = () => {
    ...
    return <View style={[styles.container,{width: screenW}]}>
      ...
      <View style={styles.statusContainer}>
        <TouchableOpacity style={[styles.playStatus,{marginRight:20}]} onPress={() => {}}> 
          <Icon name="stepbackward" size={30} color={thumbTintColor} /> 
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          {
            this.state.pause
            ? <Icon name="caretright" size={30} color={thumbTintColor} />
            : <Icon name="pause" size={25} color={thumbTintColor} />
          }
        </TouchableOpacity>
        <TouchableOpacity style={[styles.playStatus,{marginLeft:20}]} onPress={() => {}}> 
          <Icon name="stepforward" size={30} color={thumbTintColor} />
        </TouchableOpacity>
      </View>
    </View>
  }
  ...
  render () {
    ...
    return (
      <View style={styles.container}>
        <Video
          source={require('../assets/qqqg.mp3')}
          ref='video'
          volume={1.0}
          paused={pause}
          ...
          onEnd={ ()=>{
            this.setState({ pause:true,sliderValue:0,currentTime:0})
